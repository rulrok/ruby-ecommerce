...
ActiveRecord::Schema.define(version: 20_150_320_195_743) do
  ...
  add_index 'categories', %w(name ancestry), name: 'index_categories_on_name_and_ancestry', unique: true, using: :btree
  ...
  create_table 'products', force: :cascade do |t|
    ...
    t.text 'product_long_description', limit: 65_535
